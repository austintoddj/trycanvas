  ...
  <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      ...
      <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
        Not convinced yet? Try the links below to read more about what Canvas
        can do for you or spin up a live demo of your own with
        <a href="https://www.gitpod.io" class="font-bold" target="_blank"
          >Gitpod</a
        >.
      </p>
