import { ArrowRightIcon, GitHubIcon, LaravelIcon, PhpIcon, ReactIcon, TailwindIcon } from './icons';
  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-16 sm:pt-40 sm:pb-24">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        <div className="mb-8 inline-flex animate-fade-in items-center gap-2 rounded-full border border-canvas-200 bg-white/60 px-3 py-1 text-[12px] font-medium text-canvas-600 backdrop-blur dark:border-canvas-800 dark:bg-canvas-900/60 dark:text-canvas-400">
        ...
        >
          <a
            href="#install"
            className="inline-flex items-center gap-2 rounded-full bg-canvas-900 px-5 py-2.5 text-sm font-medium text-white transition-all hover:scale-[1.02] hover:bg-canvas-800 active:scale-[0.98] dark:bg-white dark:text-canvas-900 dark:hover:bg-canvas-100"
          >
            Get started
